    ...
    for region in REGIONS:
        ...
        for model in MODELS:
            if model == 'public':
                ...
                convert_segmenter_predictions_to_dicom_from_loader(DATASETS, region, localiser, segmenter, num_folds=NUM_FOLDS, test_fold=test_fold, use_manifest=USE_MANIFEST)
            else:
