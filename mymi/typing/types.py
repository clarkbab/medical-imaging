...
Point2D = Tuple[int, int]               # Required by 'Box'.
Point3D = Tuple[int, int, int]          # Required by 'Box'.
PointMM2D = Tuple[float, float]         # Required by 'Box'.
PointMM3D = Tuple[float, float, float]  # Required by 'Box'.
