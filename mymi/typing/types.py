...
ImageArrayWithFov = Union[ImageArray, Tuple[ImageArray, Tuple[SizeArray, SpacingArray, PointArray]]]
...
ImageTensorWithFov = Union[ImageTensor, Tuple[ImageTensor, Tuple[SizeTensor, SpacingTensor, PointTensor]]]
...
NiftiSeriesID = str
PatientGroup = str
PatientGroups = Union[PatientGroup, List[PatientGroup], Literal['all']]
PatientID = str
