...
class CtSeries(DicomSeries):
    def __init__(
        ...
        index = index[(index.modality == Modality.CT) & (index['series-id'] == id)]
        self.__index = index
        self.__verify_index()
    ...
    @property
    def offset(self) -> typing.PointMM3D:
    ...
    @property
    def size(self) -> typing.ImageSpacing3D:
        if self.__size is None:
            self.__load_data()
        return self.__size

    @property
    def spacing(self) -> typing.ImageSpacing3D:
