...
from mymi.typing import PatientID, PatientLandmarks, PatientRegion, PatientRegions
...
def get_registration_landmarks_evaluation(
    ...
    _, _, _, moved_landmarks = load_registration(dataset, moving_pat_id, model, fixed_pat_id=fixed_pat_id, fixed_study_id=fixed_study_id, moving_study_id=moving_study_id, landmarks=landmarks)
...
def get_registration_region_evaluation(
    ...
    # Load moved (predicted) region data.
    _, _, moved_region_data, _ = load_registration(dataset, moving_pat_id, model, fixed_pat_id=fixed_pat_id, fixed_study_id=fixed_study_id, moving_study_id=moving_study_id, regions=region)
