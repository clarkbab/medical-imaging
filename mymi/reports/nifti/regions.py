...
def get_region_summary(
    ...
    for pat_id in tqdm(pat_ids):
        ...
        # Add OAR position.
        fov_l = foreground_fov(label, spacing=pat.ct_spacing, origin=pat.ct_origin, use_world_coords=True)
        ...
        # Add OAR width.
        fov_w = foreground_fov_width(label, origin=pat.ct_origin, spacing=pat.ct_spacing, use_world_coords=True)
        ...
        fov_l = foreground_fov(lcc_label, spacing=pat.ct_spacing, origin=pat.ct_origin, use_world_coords=True)
        if fov_l is not None:
            for i, a in enumerate(axes):
                for j, e in enumerate(extrema):
        ...
        fov_width_lcc = foreground_fov_width(lcc_label, origin=pat.ct_origin, spacing=pat.ct_spacing, use_world_coords=True)
