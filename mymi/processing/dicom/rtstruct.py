...
def to_rtstruct_dicom(
    ...
    landmarks_data: Optional[LandmarksData] = None,
    landmark_prefix: str = '',
...
def add_regions_data(
    ...
    for i, (r, d) in enumerate(regions_data.items()):
        ...
        roi_contour.ROIDisplayColor = list(to_rgb_255(palette[i]))
