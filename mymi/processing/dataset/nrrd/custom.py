...
from mymi.prediction.dataset.nrrd import load_localiser_prediction
from mymi.processing import write_flag
from mymi.transforms import crop_mm_3D
from mymi.types import *
from mymi.utils import save_as_nifti
...
def convert_to_brain_crop(
    ...
    for p in tqdm(pat_ids):
        ...
        save_as_nifti(ct_data, spacing, offset, filepath)
        ...
        for r, d in region_data.items():
            ...
            save_as_nifti(d, spacing, offset, filepath)
