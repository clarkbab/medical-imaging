...
from mymi.types import ImageSize3D, ImageSpacing3D, PointMM3D
...
class RTDOSE(DicomFile):
    ...
    def __load_rtdose_data(self) -> None:
        ...
        self.__data = resample(data, origin=self.__offset, spacing=self.__spacing, output_origin=pat.ct_offset, output_size=pat.ct_size, output_spacing=pat.ct_spacing) 
