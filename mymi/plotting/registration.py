...
def plot_registration(
    ...
    fixed_centre: Optional[Union[LandmarkData, LandmarkID, RegionData, RegionID]] = None,
    ...
    moved_centre: Optional[Union[RegionData, RegionID]] = None,
    ...
    moving_centre: Optional[Union[RegionData, RegionID]] = None,
