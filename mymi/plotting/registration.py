...
def plot_registrations_matrix(
    ...
    fixed_ct_datas: Sequence[Optional[CtVolumes]] = [],
    fixed_dose_datas: Sequence[Optional[DoseDatas]] = [],
    fixed_idxs: Sequence[Optional[Union[int, float]]] = [],
    fixed_landmark_datas: Sequence[Optional[LandmarksData]] = [],
    ...
    moved_centres: Sequence[Optional[Union[str, LabelData3D]]] = [],             # Uses 'moved_region_data' if 'str', else uses 'np.ndarray'.
    moved_crops: Sequence[Optional[Union[str, LabelData3D, Box2D]]] = [],    # Uses 'moved_region_data' if 'str', else uses 'np.ndarray' or crop co-ordinates.
    moved_ct_datas: Sequence[Optional[CtVolumes]] = [],
    moved_dose_datas: Sequence[Optional[DoseDatas]] = [],
    moved_idxs: Sequence[Optional[Union[int, float]]] = [],
    moved_landmark_datas: Sequence[Optional[LandmarksData]] = [],
    moved_region_datas: Sequence[Optional[RegionsData]] = [],
    moving_centres: Sequence[Optional[Union[str, LabelData3D]]] = [],             # Uses 'moving_region_data' if 'str', else uses 'np.ndarray'.
    moving_crops: Sequence[Optional[Union[str, LabelData3D, Box2D]]] = [],    # Uses 'moving_region_data' if 'str', else uses 'np.ndarray' or crop co-ordinates.
    moving_ct_datas: Sequence[Optional[CtVolumes]] = [],
    moving_dose_datas: Sequence[Optional[DoseDatas]] = [],
    moving_idxs: Sequence[Optional[Union[int, float]]] = [],
    moving_landmark_datas: Sequence[Optional[LandmarksData]] = [],
    moving_offsets: Sequence[Optional[Point3D]] = [],
    moving_region_datas: Sequence[Optional[RegionsData]] = [],
...
def plot_registration(
    ...
    fixed_centre: Optional[Union[LandmarkData, LandmarkID, RegionArray, RegionID]] = None,
    ...
    fixed_ct_data: Optional[CtVolume] = None,
    fixed_dose_data: Optional[DoseData] = None,
    fixed_idx: Optional[int] = None,
    fixed_landmark_data: Optional[LandmarksData] = None,
    ...
    moved_ct_data: Optional[CtVolume] = None,
    ...
    moving_ct_data: Optional[CtVolume] = None,
