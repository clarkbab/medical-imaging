...
class RandomRotation:
    def __init__(self, range_x=None, range_y=None, range_z=None, fill=0, p=1.0):
        """
        kwargs:
            range_x: a (min, max) tuple describing angle range in degrees about the x-axis (frontal).
            range_y: a (min, max) tuple describing angle range in degrees about the y-axis (sagittal).
            range_z: a (min, max) tuple describing angle range in degrees about the z-axis (longitudinal).
