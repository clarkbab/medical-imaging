...
def convert_to_processed(
    ...
    logging.info(f"Converting dataset '{dataset}' into dataset '{proc_ds}', using size '{size}' and spacing '{spacing}'.")
    ...
    # Indicate success.
    _indicate_success(nifti_ds, '__CONVERT_TO_PROCESSED_SUCCESS__')
