...
def get_region_overlap_summary(
    ...
    for pat_id in tqdm(pat_ids):
        ...
        # Load region data.
        region_data = pat.regions_data(labels='all')
...
def get_region_summary(
    ...
    for pat_id in tqdm(pat_ids):
        ...
        label = pat.regions_data(labels=labels, region=region)[region]
        ...
        if pat.has_regions('Brain'):
            ...
            brain_label = pat.regions_data(region='Brain')['Brain']
...
def create_region_summary(
    ...
    for region in tqdm(regions):
        ...
        for pat_id in tqdm(pat_ids, leave=False):
            ...
            region_data = pat.regions_data(regions=region)[region]
            if pat.has_regions('Brain'):
                brain_data = pat.regions_data(regions='Brain')['Brain']
            else:
                brain_data = None
