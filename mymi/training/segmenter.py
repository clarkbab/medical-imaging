...
def train_segmenter(
    ...
    # Create data loaders.
    loaders = Loader.build_loaders(datasets, region, extract_patch=True, num_folds=num_folds, num_samples=num_samples, num_workers=num_workers, p_val=p_val, spacing=spacing, test_fold=test_fold, transform=transform)
