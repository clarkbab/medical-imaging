...
from mymi.loaders import MultiLoaderConvergence
...
from mymi.models.lightning_modules import MultiSegmenterConvergence
...
def train_multi_segmenter_convergence(
    ...
    **kwargs) -> None:
    ...
    if loss_fn == 'dice':
        ...
        logging.info(f"Using lambda={lam}")
    else:
        raise ValueError(f"Loss function '{loss_fn}' not recognised.")
    ...
    # Create model.
    model = MultiSegmenterConvergence(
